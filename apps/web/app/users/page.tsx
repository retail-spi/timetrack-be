  ...
  return (
    <div className="p-6 md:p-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-[22px] font-semibold text-gray-900 tracking-tight">Utilisateurs</h1>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-2xl border border-gray-200 p-5 mb-5 max-w-xl">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-[15px] font-semibold text-gray-900">Nouvel utilisateur</h2>
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <div className="flex gap-1.5 mt-2 flex-wrap">
                  <span className="bg-blue-50 text-blue-600 px-2.5 py-0.5 rounded-full text-[11px] font-medium">
                    {roleLabel[user.role] || user.role}
                  </span>
                  <span className="bg-gray-100 text-gray-500 px-2.5 py-0.5 rounded-full text-[11px] font-medium">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-100">
              <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Nom</th>
              <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Email</th>
              <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Rôle</th>
              <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Scope</th>
          ...
          <tbody>
            {users.map((user) => (
              <tr key={user.id} className="border-b border-gray-100 last:border-0 hover:bg-gray-50/50 transition-colors">
                <td className="px-4 py-3 text-[13px] font-medium text-gray-900">{user.firstName} {user.lastName}</td>
                <td className="px-4 py-3 text-[13px] text-gray-500">{user.email}</td>
